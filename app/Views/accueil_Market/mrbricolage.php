<?php $this->layout('layoutclient', ['title' => 'mr bricolage']) ?>
                ...
                <div class="row">
                    <div class="col-md-3 col-md-12" id="shop">
                        <div class="list-group">
                            <a href="<?=$this->url('/mrbricolage)?>" class="list-group-item primary">
...
<!--<div class="alert alert-success" role="alert" style="animation:fadein 3s;">Votre inscription à été transmise vous pouvez vous connectez</div>-->
    ...
    <div class="col-md-9" >
	      ...
	      <img src="<?= $this->assetUrl('img/bricolage1.png') ;?>" style="margin-left:5em;">
