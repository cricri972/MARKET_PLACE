<?php $this->layout('layout', ['title' => 'Détails utilisateur']) ?>
...
<br>
<a href="<?php echo $this->url('Users_deleteUser',['id' => $descriptif['id']]);?>" class="btn btn-warning">Confirmer la suppression</a>
